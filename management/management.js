(function(){
  ...
  const sb=window.supabase.createClient(URL,KEY,{global:{fetch:CITLRuntime.timedFetch},auth:{storageKey:'sb-main-auth',persistSession:true,autoRefreshToken:true}});
